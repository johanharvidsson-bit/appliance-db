...
| Foundation contract and privilege tests | Partial runtime evidence | Existing 012–014 integration suites cover deployed dev behavior. New 015–018 have static contract/security tests but have not run against an approved dev DSN/PostgREST. |
...
1. apply migrations 011–018 to the isolated Marine dev database and run all
